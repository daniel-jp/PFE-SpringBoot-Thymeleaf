 ...
 * 
 * @Autowired public DataFieldcontroller(IFieldFormService iFieldFormService) {
 * this.iFieldFormService = iFieldFormService; }
 * 
 * // ADD DATE
 * FIELD=============================================================
 * 
 * @RequestMapping("/addDatefield") public ModelAndView addDatefield(Model
 ...
 * 
 * model.addAttribute("mode", "new"); mv.addObject("datef", fieldForm);
 * 
 * return mv; }
 * 
 * // SAVE DATE FIELD
 * 
 * @PostMapping(path = "/saveDatefield") public String saveDateField(Model
 * model, FieldRequest fieldRequest, BindingResult bindingResult) { if
 ...
 * model.addAttribute("datef", fieldForm);
 * 
 * return "/admin/items/formitem"; }
 * 
 * // UPDATE DATE FIELD=======================================================
 * 
 * @GetMapping(path = "/updateDatefield") public String updateDatefield(Model
 ...
 * 
 * @PostMapping("/changeDatefield") public String changeDatefield(Model
 ...
 * return "admin/items/formitem"; }
 * 
 * @GetMapping(path = "/deleteDatefield") public String deleteDatefield(String
